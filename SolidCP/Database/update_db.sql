...
GO
IF NOT EXISTS (SELECT * FROM SYS.TABLES WHERE name = 'TrustedSites')
BEGIN
CREATE TABLE [dbo].[TrustedSites](
	[ID] [int] IDENTITY(1,1) NOT NULL,
	[Url] [nvarchar](255) NOT NULL,
	[Comments] [nvarchar](max) NULL,
 CONSTRAINT [PK_TrustedSites] PRIMARY KEY CLUSTERED 
(
	[ID] ASC
...
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM [dbo].[SystemSettings] WHERE [SettingsName] = 'LetsEncrypt')
BEGIN
INSERT INTO [dbo].[SystemSettings] ([SettingsName],[PropertyName],[PropertyValue])
	VALUES ('LetsEncrypt','Endpoint','https://acme-v01.api.letsencrypt.org/'),
			('LetsEncrypt','StagingEndpoint','https://acme-staging.api.letsencrypt.org/'),
			('LetsEncrypt','testmode','True'),
			('LetsEncrypt','AutoRenew','False'),
			('LetsEncrypt','PrefetchWarmup','True'),
			('LetsEncrypt','RegTerm','60'),
...
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM [dbo].[Quotas] WHERE [QuotaID] = '335')
BEGIN
INSERT into [dbo].[Quotas] ([QuotaID], [GroupID], [QuotaOrder], [QuotaName], [QuotaDescription], [QuotaTypeID], [ServiceQuota], [ItemTypeID], [HideQuota]) 
VALUES (335, 2, 21, N'Web.LetsEncryptSSL', N'SSL from Let''s Encrypt', 1, 0, NULL, NULL)
END
GO
...
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM [dbo].[ServiceDefaultProperties] WHERE [ProviderID] = '105' AND [PropertyName] = 'ACMESharpVaultProfilesRootPath')
BEGIN
INSERT [dbo].[ServiceDefaultProperties] ([ProviderID], [PropertyName], [PropertyValue]) 
VALUES (105, N'ACMESharpVaultProfilesRootPath', N'%SYSTEMDRIVE%\ProgramData\ACMESharp\vaultProfiles')
END
GO
...
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM [dbo].[ServiceDefaultProperties] WHERE [ProviderID] = '112' AND [PropertyName] = 'ACMESharpVaultProfilesRootPath')
BEGIN
INSERT [dbo].[ServiceDefaultProperties] ([ProviderID], [PropertyName], [PropertyValue]) 
VALUES (112, N'ACMESharpVaultProfilesRootPath', N'%SYSTEMDRIVE%\ProgramData\ACMESharp\vaultProfiles')
END
GO
...
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM [dbo].[ScheduleTasks] WHERE [TaskID] = 'SCHEDULE_TASK_LETSENCRYPT_RENEWAL' )
BEGIN
INSERT [dbo].[ScheduleTasks] ([TaskID], [TaskType], [RoleID]) 
VALUES (N'SCHEDULE_TASK_LETSENCRYPT_RENEWAL', N'SolidCP.EnterpriseServer.LetsEncryptRenewalTask, SolidCP.EnterpriseServer.Code', 1)
END
GO
...
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM [dbo].[ScheduleTaskParameters] WHERE [TaskID] = 'SCHEDULE_TASK_LETSENCRYPT_RENEWAL'  AND [ParameterID] = 'DAYS_BEFORE')
BEGIN
INSERT [dbo].[ScheduleTaskParameters] ([TaskID], [ParameterID], [DataTypeID], [DefaultValue], [ParameterOrder]) 
VALUES (N'SCHEDULE_TASK_LETSENCRYPT_RENEWAL', N'DAYS_BEFORE', N'Int', N'30', 1)
END
GO
...
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM [dbo].[ScheduleTaskParameters] WHERE [TaskID] = 'SCHEDULE_TASK_LETSENCRYPT_RENEWAL' AND [ParameterID] = 'NOTIFY_EMAIL')
BEGIN
INSERT [dbo].[ScheduleTaskParameters] ([TaskID], [ParameterID], [DataTypeID], [DefaultValue], [ParameterOrder]) 
VALUES (N'SCHEDULE_TASK_LETSENCRYPT_RENEWAL', N'NOTIFY_EMAIL', N'String', NULL, 3)
END
GO
...
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM [dbo].[ScheduleTaskParameters] WHERE [TaskID] = 'SCHEDULE_TASK_LETSENCRYPT_RENEWAL' AND [ParameterID] = 'NOTIFY_OWNER')
BEGIN
INSERT [dbo].[ScheduleTaskParameters] ([TaskID], [ParameterID], [DataTypeID], [DefaultValue], [ParameterOrder]) 
VALUES (N'SCHEDULE_TASK_LETSENCRYPT_RENEWAL', N'NOTIFY_OWNER', N'Boolean', N'false', 2)
END
GO
...
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM [dbo].[ScheduleTaskViewConfiguration] WHERE [TaskID] = 'SCHEDULE_TASK_LETSENCRYPT_RENEWAL' )
BEGIN
INSERT [dbo].[ScheduleTaskViewConfiguration] ([TaskID], [ConfigurationID], [Environment], [Description]) 
VALUES (N'SCHEDULE_TASK_LETSENCRYPT_RENEWAL', N'ASP_NET', N'ASP.NET', N'~/DesktopModules/SolidCP/ScheduleTaskControls/LetsEncryptRenewalView.ascx')
END
GO
...
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM [dbo].[UserSettings] WHERE [SettingsName] = 'LetsEncryptRenewalAdminNotificationLetter' AND [PropertyName] = 'CC')
BEGIN
INSERT [dbo].[UserSettings] ([UserID], [SettingsName], [PropertyName], [PropertyValue]) 
VALUES (1, N'LetsEncryptRenewalAdminNotificationLetter', N'CC', N'support@HostingCompany.com')
END
GO
...
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM [dbo].[UserSettings] WHERE [SettingsName] = 'LetsEncryptRenewalAdminNotificationLetter' AND [PropertyName] = 'From')
BEGIN
INSERT [dbo].[UserSettings] ([UserID], [SettingsName], [PropertyName], [PropertyValue]) 
VALUES (1, N'LetsEncryptRenewalAdminNotificationLetter', N'From', N'support@HostingCompany.com')
END
GO
...
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM [dbo].[UserSettings] WHERE [SettingsName] = 'LetsEncryptRenewalAdminNotificationLetter' AND [PropertyName] = 'HtmlBody')
BEGIN
INSERT [dbo].[UserSettings] ([UserID], [SettingsName], [PropertyName], [PropertyValue]) 
VALUES (1, N'LetsEncryptRenewalAdminNotificationLetter', N'HtmlBody', N'<html xmlns="http://www.w3.org/1999/xhtml">
<head>
    <title>Let''s Encrypt SSL Renewal Information</title>
    <style type="text/css">
...
<p>
Please, find below details of SSL certificate renewals.
</p>
...
<table>
    <thead>
        <tr>
			...
			<th>SANs (if any)</th>
            <th>Account name</th>
            <th>Expiration Date (before renewal)</th>
			<th>Status of renewal</th>
        </tr>
    </thead>
    <tbody>
		<ad:foreach collection="#Certificates#" var="CertificateAndStatus" index="i">
        <tr>
            <td>#CertificateAndStatus.Certificate.HostName#</td>
			<td>#iif(isnull(CertificateAndStatus.Certificate.SAN), "", CertificateAndStatus.Certificate.SAN)#</td>
			<td>#CertificateAndStatus.Username#</td>
            <td>#iif(isnull(CertificateAndStatus.Certificate.ExpiryDate), "", CertificateAndStatus.Certificate.ExpiryDate)#</td>
			<td><ad:if test="#CertificateAndStatus.Success#">Success<ad:else>Failure: #CertificateAndStatus.ErrorDescription#</ad:if></td>
        </tr>
		</ad:foreach>
    </tbody>
</table>
...
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM [dbo].[UserSettings] WHERE [SettingsName] = 'LetsEncryptRenewalAdminNotificationLetter' AND [PropertyName] = 'Priority')
BEGIN
INSERT [dbo].[UserSettings] ([UserID], [SettingsName], [PropertyName], [PropertyValue]) 
VALUES (1, N'LetsEncryptRenewalAdminNotificationLetter', N'Priority', N'Normal')
END
GO
...
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM [dbo].[UserSettings] WHERE [SettingsName] = 'LetsEncryptRenewalAdminNotificationLetter' AND [PropertyName] = 'Subject')
BEGIN
INSERT [dbo].[UserSettings] ([UserID], [SettingsName], [PropertyName], [PropertyValue]) 
VALUES (1, N'LetsEncryptRenewalAdminNotificationLetter', N'Subject', N'Let''s Encrypt certificate renewal notification')
END
GO
...
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM [dbo].[UserSettings] WHERE [SettingsName] = 'LetsEncryptRenewalAdminNotificationLetter' AND [PropertyName] = 'TextBody')
BEGIN
INSERT [dbo].[UserSettings] ([UserID], [SettingsName], [PropertyName], [PropertyValue]) 
VALUES (1, N'LetsEncryptRenewalAdminNotificationLetter', N'TextBody', N'=================================
   Let''s Encrypt SSL Renewal Information
=================================
<ad:if test="#user#">
Hello #user.FirstName#,
...
<ad:foreach collection="#Certificates#" var="CertificateAndStatus" index="i">
	Common name: #CertificateAndStatus.Certificate.HostName#
	SANs (if any): #iif(isnull(CertificateAndStatus.Certificate.SAN), "", CertificateAndStatus.Certificate.SAN)#
	Account name: #CertificateAndStatus.Username#
	Expiration Date (before renewal): #iif(isnull(CertificateAndStatus.Certificate.ExpiryDate), "", CertificateAndStatus.Certificate.ExpiryDate)#
	Status of renewal: <ad:if test="#CertificateAndStatus.Success#">Success<ad:else>Failure: #CertificateAndStatus.ErrorDescription#</ad:if>
</ad:foreach>
...
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM [dbo].[UserSettings] WHERE [SettingsName] = 'LetsEncryptRenewalNotificationLetter' AND [PropertyName] = 'CC')
BEGIN
INSERT [dbo].[UserSettings] ([UserID], [SettingsName], [PropertyName], [PropertyValue]) 
VALUES (1, N'LetsEncryptRenewalNotificationLetter', N'CC', N'support@HostingCompany.com')
END
GO
...
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM [dbo].[UserSettings] WHERE [SettingsName] = 'LetsEncryptRenewalNotificationLetter' AND [PropertyName] = 'From')
BEGIN
INSERT [dbo].[UserSettings] ([UserID], [SettingsName], [PropertyName], [PropertyValue]) 
VALUES (1, N'LetsEncryptRenewalNotificationLetter', N'From', N'support@HostingCompany.com')
END
GO
...
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM [dbo].[UserSettings] WHERE [SettingsName] = 'LetsEncryptRenewalNotificationLetter' AND [PropertyName] = 'HtmlBody')
BEGIN
INSERT [dbo].[UserSettings] ([UserID], [SettingsName], [PropertyName], [PropertyValue]) 
VALUES (1, N'LetsEncryptRenewalNotificationLetter', N'HtmlBody', N'<html xmlns="http://www.w3.org/1999/xhtml">
<head>
    <title>Let''s Encrypt SSL Renewal Information</title>
    <style type="text/css">
		.Summary { background-color: ##ffffff; padding: 5px; }
...
<table>
    ...
    <tbody>
        <tr>
			...
			<td>#iif(isnull(Certificate.SAN), "", Certificate.SAN)#</td>
            <td>#iif(isnull(Certificate.ExpiryDate), "", Certificate.ExpiryDate)#</td>
			<td><ad:if test="#Success#">Success<ad:else>Failure: #ErrorDescription#</ad:if></td>
        </tr>
    </tbody>
</table>
<p>
...
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM [dbo].[UserSettings] WHERE [SettingsName] = 'LetsEncryptRenewalNotificationLetter' AND [PropertyName] = 'Priority')
BEGIN
INSERT [dbo].[UserSettings] ([UserID], [SettingsName], [PropertyName], [PropertyValue]) 
VALUES (1, N'LetsEncryptRenewalNotificationLetter', N'Priority', N'Normal')
END
GO
...
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM [dbo].[UserSettings] WHERE [SettingsName] = 'LetsEncryptRenewalNotificationLetter' AND [PropertyName] = 'Subject')
BEGIN
INSERT [dbo].[UserSettings] ([UserID], [SettingsName], [PropertyName], [PropertyValue]) 
VALUES (1, N'LetsEncryptRenewalNotificationLetter', N'Subject', N'Let''s Encrypt certificate renewal notification')
END
GO
...
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM [dbo].[UserSettings] WHERE [SettingsName] = 'LetsEncryptRenewalNotificationLetter' AND [PropertyName] = 'TextBody')
BEGIN
INSERT [dbo].[UserSettings] ([UserID], [SettingsName], [PropertyName], [PropertyValue]) 
VALUES (1, N'LetsEncryptRenewalNotificationLetter', N'TextBody', N'=================================
   Let''s Encrypt SSL Renewal Information
=================================
<ad:if test="#user#">
Hello #user.FirstName#,
...
Common name: #Certificate.HostName#
SANs (if any): #iif(isnull(Certificate.SAN), "", Certificate.SAN)#
Expiration Date (before renewal): #iif(isnull(Certificate.ExpiryDate), "", Certificate.ExpiryDate)#
Status of renewal: <ad:if test="#Success#">Success<ad:else>Failure: #ErrorDescription#</ad:if>
If you have any questions regarding your hosting account, feel free to contact our support department at any time.
Best regards')
END
GO
...
INSERT INTO [dbo].[SSLCertificates]
	([UserID], [SiteID], [FriendlyName], [Hostname], [DistinguishedName], [CSRLength], [SerialNumber], [ValidFrom], [ExpiryDate], [Installed], [IsLetsEncryptCertificate], [SAN])
VALUES
	(@UserID, @WebSiteID, @FriendlyName, @HostName, @DistinguishedName, @CSRLength, @SerialNumber, @ValidFrom, @ExpiryDate, 1, @IsLetsEncryptCertificate, @SAN)
...
GO
CREATE PROCEDURE [dbo].GetAllSslCertificatesToRenew
(
	@DaysBeforeExpiry int,
	@OnlyLetsEncrypt bit
)
AS
SELECT	[ID], [UserID], [SiteID], [FriendlyName], [Hostname], [DistinguishedName], [CSR], [CSRLength], [Certificate], [Hash], [Installed], [IsRenewal], [ValidFrom], [ExpiryDate], [SerialNumber], [PreviousId], [IsLetsEncryptCertificate], [SAN]
FROM	[dbo].[SSLCertificates]
WHERE	DATEDIFF(day, getdate(), ExpiryDate) < @DaysBeforeExpiry AND (@OnlyLetsEncrypt = IsLetsEncryptCertificate OR @OnlyLetsEncrypt = 0)
...
GO
CREATE PROCEDURE [dbo].GetAllTrustedSites
AS
SELECT
	   [ID],
	   [Url],
	   [Comments]
  FROM [dbo].[TrustedSites]
...
SELECT
	...
	[CSR], [CSRLength], [Certificate], [Hash], [Installed], [IsRenewal], [ValidFrom], 
	[ExpiryDate], [SerialNumber], [PreviousId], [IsLetsEncryptCertificate], [SAN]
FROM
	[dbo].[SSLCertificates]
WHERE
	[SiteID] = @WebSiteID
...
SELECT
	[ID], [UserID], [SiteID], [FriendlyName], [Hostname], [DistinguishedName], [CSR], [CSRLength], [Certificate], [Hash], [Installed], [IsRenewal], [ValidFrom], [ExpiryDate], [SerialNumber], [PreviousId], [IsLetsEncryptCertificate], [SAN]
FROM
	[dbo].[SSLCertificates]
INNER JOIN
...
SELECT
	[ID], [UserID], [SiteID], [FriendlyName], [Hostname], [DistinguishedName], [CSR], 
	[CSRLength], [Certificate], [Hash], [Installed], [IsRenewal], [ValidFrom], [ExpiryDate], 
	[SerialNumber], [PreviousId], [IsLetsEncryptCertificate], [SAN]
FROM
	[dbo].[SSLCertificates]
INNER JOIN
	[dbo].[ServiceItems] AS [SI] ON [SSLCertificates].[SiteID] = [SI].[ItemID]
