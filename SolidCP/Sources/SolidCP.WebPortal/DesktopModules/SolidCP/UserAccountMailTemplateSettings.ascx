...
<div class="panel-body form-horizontal">
    <ul class="LinksList">
        ...
        <li>
            <asp:HyperLink ID="lnkLetsEncryptRenewalNotificationLetter" runat="server" meta:resourcekey="lnkLetsEncryptRenewalNotificationLetter"
                Text="Let's Encrypt Renewal Notification - Account Level" NavigateUrl='<%# GetSettingsLink("LetsEncryptRenewalNotificationLetter", "SettingsLetsEncryptRenewalNotificationLetter") %>'></asp:HyperLink>
        </li>
        <li>
            <asp:HyperLink ID="lnkLetsEncryptRenewalAdminNotificationLetter" runat="server" meta:resourcekey="lnkLetsEncryptRenewalAdminNotificationLetter"
                Text="Let's Encrypt Renewal Notification - Administrator Level" NavigateUrl='<%# GetSettingsLink("LetsEncryptRenewalAdminNotificationLetter", "SettingsLetsEncryptRenewalAdminNotificationLetter") %>'></asp:HyperLink>
        </li>
    </ul>
</div>
