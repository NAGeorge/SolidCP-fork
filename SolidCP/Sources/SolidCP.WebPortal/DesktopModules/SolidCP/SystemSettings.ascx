...
<div class="panel-body">
    <div class="container">
        ...
        <div class="panel panel-default" id="AccessLEPanel" runat="server">
            <div class="panel-heading panel-heading-link">
                <span><i class="fa fa-cogs" aria-hidden="true">&nbsp;</i>&nbsp;</span>
                <a data-toggle="collapse" data-parent="#accordion" href="#AccessLESettings" aria-expanded="false" class="collapsed">
                    <asp:Localize ID="HeaderLetsEncryptSettings" runat="server" meta:resourcekey="HeaderLetsEncryptSettings" /><span class='fa fa-plus pull-right' aria-hidden='true'> </span>
                </a>
            </div>
            <div id="AccessLESettings" class="panel-collapse collapse" aria-expanded="false" style="height: 0px;">
                <div class="panel-body">
                    <div class="row">
                        <br />
                        <div class="col-md-12">
                            <div class="alert alert-info">
                                <p>
                                    <asp:Localize ID="SettingsLERateLimitNotice" runat="server" meta:resourcekey="SettingsLERateLimitNotice" />
                                    <a href="https://letsencrypt.org/docs/rate-limits/" target="_blank">https://letsencrypt.org/docs/rate-limits/</a></p>
                            </div>
                        </div>
                        <br />
                    </div>
                    <fieldset>
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <div class="col-sm-8">
                                        <asp:CheckBox ID="SettingLEActiveCheckbox" runat="server" Text="Yes" meta:resourcekey="SettingsLEActieEnable" />
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <div class="col-md-8">
                                        <asp:CheckBox ID="SettingsLeAutoRenewCheckbox" runat="server" Text="Yes" meta:resourcekey="SettingsLEAutoRenewlEnable" />
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <CPCC:H5Label runat="server">
                                            <asp:Localize ID="SettingsLEAutoRenewPeriodLabel" runat="server" meta:resourcekey="SettingsLEAutoRenewPeriodLabel" />
                                    </CPCC:H5Label>
                                    <div class="col-md-8">
                                        <asp:TextBox type="number" min="30" max="90" runat="server" ID="SettingsLEAutoRenewPeriod" meta:resourcekey="SettingsLEAutoRenewPeriod" CssClass="form-control" />
                                        <asp:RegularExpressionValidator ID="SettingsLEAutoRenewPeriodValidator" ControlToValidate="SettingsLEAutoRenewPeriod" runat="server" ErrorMessage="Only Numbers allowed" ValidationExpression="\d+"></asp:RegularExpressionValidator>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <CPCC:H5Label runat="server">
                                            <asp:Localize ID="SettingsLEPrefetchWarmup" runat="server" meta:resourcekey="SettingsLEPrefetchWarmupLabel" />
                                    </CPCC:H5Label>
                                    <div class="col-md-8">
                                        <asp:CheckBox runat="server" ID="SettingsLePrefetchCheckbox" Text="Yes" meta:resourcekey="SettingsLePrefetchCheckbox" />
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <CPCC:H5Label runat="server">
                                            <asp:Localize ID="SettingsLETestMode" runat="server" meta:resourcekey="SettingsLETestModeLabel" />
                                    </CPCC:H5Label>
                                    <div class="col-md-8">
                                        <asp:CheckBox runat="server" ID="SettingsLeTestModeCheckbox" Text="Yes" meta:resourcekey="SettingsLeTestModeCheckbox" />
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <CPCC:H5Label runat="server">
                                            <asp:Localize ID="SettingsLEEndpointLabel" runat="server" meta:resourcekey="SettingsLEEndpointLabel" />
                                    </CPCC:H5Label>
                                    <div class="col-md-8">
                                        <asp:TextBox runat="server" ID="SettingsLEEndpoint" meta:resourcekey="SettingsLEEndpoint" CssClass="form-control" />
                                        <asp:RegularExpressionValidator ID="SettingsLEEndpointValidator" ControlToValidate="SettingsLEEndpoint" runat="server" ErrorMessage="Please enter a valid URL" ValidationExpression="^((http|https)://)?([\w-]+\.)+[\w]+(/[\w- ./?]*)?$"></asp:RegularExpressionValidator>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <CPCC:H5Label runat="server">
                                            <asp:Localize ID="SettingsLEStagingEndpointLabel" runat="server" meta:resourcekey="SettingsLEStagingEndpointLabel" />
                                    </CPCC:H5Label>
                                    <div class="col-md-8">
                                        <asp:TextBox runat="server" ID="SettingsLEStagingEndpoint" meta:resourcekey="SettingsLEStagingEndpoint" CssClass="form-control" />
                                        <asp:RegularExpressionValidator ID="SettingsLEStagingEndpointValidator" ControlToValidate="SettingsLEStagingEndpoint" runat="server" ErrorMessage="Please enter a valid URL" ValidationExpression="^((http|https)://)?([\w-]+\.)+[\w]+(/[\w- ./?]*)?$"></asp:RegularExpressionValidator>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="panel-footer text-right">
                        <CPCC:StyleButton ID="StyleButton10" CssClass="btn btn-success btn-block" runat="server" meta:resourcekey="SettingbtnSaveSettings" OnClick="btnSaveLetsEncrypt_Click" />
                    </div>
                </div>
            </div>
        </div>
