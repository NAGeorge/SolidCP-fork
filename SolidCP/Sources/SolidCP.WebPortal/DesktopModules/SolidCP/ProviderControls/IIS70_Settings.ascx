...
<fieldset>
    ...
    <table width="100%" cellpadding="4">
        ...
        <tr>
            ...
            <tr>
	        <td width="200" class="Normal" valign="top">
	            <asp:Label ID="lblACMESharpVaultProfilesRootPath" runat="server" Text="ACMESharp Vault Profiles path:"></asp:Label>
	        </td>
            <td class="Normal" valign="top">
                <asp:TextBox ID="txtACMESharpVaultProfilesRootPath" runat="server" CssClass="NormalTextBox" Width="400px"></asp:TextBox>
            </td>
        </tr>
        </tbody>
	    <tr>
